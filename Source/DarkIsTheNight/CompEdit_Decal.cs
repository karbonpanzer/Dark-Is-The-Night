...
namespace DarkIsTheNight
{
    public sealed class CompEditDecalMarker : ThingComp
    {
        ...
        public override void PostExposeData()
        {
            ...
            Scribe_Values.Look(ref ProfileSet.Helmet.Active, "DarkIsTheNightDecalHelmetActive");
            Scribe_Values.Look(ref ProfileSet.Helmet.SymbolPath, "DarkIsTheNightDecalHelmetPath", "");
            Scribe_Values.Look(ref ProfileSet.Helmet.SymbolColor, "DarkIsTheNightDecalHelmetColor", Color.white);

            Scribe_Values.Look(ref ProfileSet.Armor.Active, "DarkIsTheNightDecalArmorActive");
            Scribe_Values.Look(ref ProfileSet.Armor.SymbolPath, "DarkIsTheNightDecalArmorPath", "");
            Scribe_Values.Look(ref ProfileSet.Armor.SymbolColor, "DarkIsTheNightDecalArmorColor", Color.white);
        }
